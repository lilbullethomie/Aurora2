...
local weaponMeta = loadstring(game:HttpGet("https://raw.githubusercontent.com/sstvskids/Polaris/main/Bedwars/weaponMeta", true))()
local Functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/sstvskids/Polaris/main/Bedwars/Functions.lua", true))()
local Utilities = loadstring(game:HttpGet("https://raw.githubusercontent.com/sstvskids/Polaris/main/Libraries/utils.lua", true))()
	...
	Function = function(callback)
		if callback then
			...
			repeat task.wait(4)
				...
				task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Break some beds with Aurora // FqrVKaHnaw | Aurora On Top", "All")
				task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Get some wins with Aurora //FqrVKaHnaw// | Aurora On Top", "All")
                task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("CocoSkid? Never heard of it | Aurora On Top", "All")
                task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Aether better than Aurora | Aurora On Top", "All")
...
local function onPlayerDeath(deadPlayer)
    if deadPlayer.Team ~= player.Team then
        local messages = {
            "CocoKiwi On Top " .. deadPlayer.Name .. " ",
	...
	Function = function(callback)
		if callback then
            if inventory.fireball then
                ...
                CreateNotification("Longjump", 'Please walk to start longjump.', 5)
